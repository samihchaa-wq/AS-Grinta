...
void main() {
  group('contrat PWA', () {
    ...
    test('la version web correspond à la version de l’application', () {
      ...
      final webVersion = RegExp(r"AS_GRINTA_WEB_VERSION\s*=\s*'([^']+)'")
          .firstMatch(versionScript)
          ?.group(1);
    ...
    test('la mise à jour attend une action utilisateur avant de prendre le contrôle', () {
      ...
      expect(shell, contains("bar.addEventListener('click', activateUpdate)"));
