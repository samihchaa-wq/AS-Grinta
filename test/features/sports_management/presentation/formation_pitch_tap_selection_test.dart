...
void main() {
  ...
  testWidgets('poste occupé puis remplaçant déclenche le placement sur ce poste',
      (tester) async {
  ...
  testWidgets('poste vide puis joueur place le joueur sur le poste sélectionné',
      (tester) async {
    final starter = _entry(
      id: 'starter',
      name: 'Starter',
  ...
  testWidgets('poste occupé puis autre titulaire prépare un échange de postes',
      (tester) async {
    final first = _entry(
      id: 'first',
      name: 'First',
