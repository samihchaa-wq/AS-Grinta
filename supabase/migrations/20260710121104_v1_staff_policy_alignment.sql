...
drop policy if exists season_players_staff_insert on public.season_players;
drop policy if exists season_players_staff_update on public.season_players;
drop policy if exists season_players_staff_delete on public.season_players;
