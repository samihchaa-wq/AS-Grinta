...
-- Reconstitution fidèle du correctif déjà appliqué en production : depuis
-- l'ajout des faits durables du compte rendu, delete_match doit les retirer
-- avant les participants auxquels ils référencent.
