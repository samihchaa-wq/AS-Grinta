...
-- La fenêtre post-match a une seule échéance métier : exactement 24 heures
-- après la première validation du compte rendu. L'état du scrutin HDM ne doit
-- jamais raccourcir cette fenêtre.
...
-- Un administrateur ne peut pas annuler un scrutin encore ouvert ou en attente
-- afin de provoquer une clôture anticipée. La clôture reste automatique à T+24 h.
-- Le traitement historique d'un scrutin déjà clos est conservé pour compatibilité
-- avec les anciennes données et les outils d'audit.
