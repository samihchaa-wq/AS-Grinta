...
-- Une désactivation d'effectif ne doit jamais effacer l'historique sportif.
-- Seule la saison ouverte masque ses joueurs inactifs ; les saisons terminées,
-- la période précédente et le cumul toutes saisons conservent les lignes ayant
-- participé à l'historique, même après archivage ou suppression du compte.
...
comment on view public.v_statistics_players is
  'Statistiques joueurs par période ; les saisons closes conservent les joueurs inactifs et les comptes supprimés.';
