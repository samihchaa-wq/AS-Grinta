-- Retire la marge bookmaker de 5 % : les cotes suggérées sont désormais les
-- cotes équitables (1 / probabilité), à la demande du club.
...
begin
  ...
  return jsonb_build_object(
    'win', round((1 / p_win)::numeric, 2),
    'draw', round((1 / p_draw)::numeric, 2),
    'loss', round((1 / p_loss)::numeric, 2)
  );
end;
$$;
