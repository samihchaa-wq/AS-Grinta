alter table public.match_internal_compositions
  add column if not exists team1_jersey text not null default 'orange',
  add column if not exists team2_jersey text not null default 'blue';
