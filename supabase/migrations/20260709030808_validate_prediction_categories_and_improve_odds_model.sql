...
drop trigger if exists trg_validate_season_prediction_category on public.season_predictions;
...
revoke execute on function public.validate_season_prediction_category() from public, anon, authenticated;
...
revoke execute on function public.compute_match_odds(uuid) from public, anon, authenticated;;
