-- L'en-tête de la page Homme du match affichait toujours « AS Grinta X – Y
-- adversaire », alors que le reste de l'app affiche l'équipe qui reçoit en
-- premier. Pour un match à l'extérieur, le score paraissait donc inversé par
-- rapport aux autres écrans. On expose is_home dans get_match_motm_vote pour
-- que le client puisse ordonner l'affichage correctement.
