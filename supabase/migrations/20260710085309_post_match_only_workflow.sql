...
-- Remove every database object used exclusively by live match control.
...
-- Post-match goals remain editable only by staff.
...
-- A public count is visible while individual predictions remain private.
...
-- Validation is atomic. AS Grinta's score is derived from player and guest goals.
...
-- Ensure the five-minute cutoff is enforced server-side for inserts and updates.
