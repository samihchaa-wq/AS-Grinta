...
drop function if exists public.moderator_update_profile_admin_fields(uuid,text,text,boolean);
drop function if exists public.is_exact_moderator();
drop function if exists public.validate_season_prediction_category();
