-- Feuille de match d'un match terminé : un joueur réellement présent mais
-- ajouté après la publication de la compo (donc absent du snapshot) n'apparais-
-- sait nulle part. On l'ajoute désormais comme remplaçant dans la compo publiée.
...
begin
  ...
  -- Présents réels absents du snapshot (ajoutés après coup) : on les ajoute
  -- comme remplaçants. Ne concerne qu'un match déjà joué (présence renseignée).
