-- La saison précédente utilise l'import historique uniquement lorsqu'aucun
-- effectif applicatif n'existe pour la saison juste avant la saison ouverte.
-- Dès qu'une nouvelle saison est ouverte, l'ancienne saison actuelle devient
-- donc automatiquement la saison précédente, même avec zéro but/stat joueur.
