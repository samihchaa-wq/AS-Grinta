-- Cohérence « surnom prioritaire » : l'éditeur de composition (admin) lit
-- private.composition_snapshot, qui affichait le prénom + nom réels au lieu du
-- surnom. On priorise le surnom comme partout ailleurs dans l'app (et pour le
-- tri), avec repli sur prénom + nom.
