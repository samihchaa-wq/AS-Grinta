...
-- Métriques alignées sur le nouveau catalogue (ajout de max_match_goals ;
-- retrait des métriques « pronos saison » et hattricks devenues inutiles).
...
-- Réattribution complète sur le nouveau catalogue.
