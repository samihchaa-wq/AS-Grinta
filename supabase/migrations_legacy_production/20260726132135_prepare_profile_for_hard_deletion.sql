...
comment on function private.prepare_profile_for_hard_deletion(uuid) is
  'Nettoie ou réattribue les références historiques bloquantes avant la suppression Auth d un profil.';;
