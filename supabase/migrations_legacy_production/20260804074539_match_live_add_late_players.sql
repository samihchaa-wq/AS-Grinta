...
-- The original feature migration redefines the workspace function. Apply its
-- intended recovery behavior, then finish this same migration with the unified
-- T-15 lifecycle so production never exposes the legacy kickoff-only window.
