...
La valeur historique `moderateur` doit être migrée vers `admin` en base puis retirée des contrôles et de l'interface. Les anciennes migrations restent immuables.
