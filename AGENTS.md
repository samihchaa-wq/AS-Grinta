...
- Les cotes suivent exclusivement le modèle V2.1 avec pondération 40/25/18/10/7 %, nul indépendant et marge bookmaker obligatoire de 5 % appliquée après les probabilités équitables.
